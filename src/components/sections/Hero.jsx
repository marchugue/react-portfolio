  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 section-padding max-w-7xl mx-auto text-center">
        ...
        >
          A first-year student passionate about creating digital experiences.
          Skilled in React, PHP, Python, Java, MySQL, C++, and design tools like Figma & Photoshop.
        </motion.p>
        ...
        >
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className="px-8 py-4 bg-gradient-to-r from-primary-500 to-primary-600 text-white font-semibold rounded-full hover:shadow-lg hover:shadow-primary-500/25 transition-all"
          >
            View My Work
          </motion.a>
          <motion.a
            ...
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="px-8 py-4 glass-card text-white font-semibold rounded-full hover:bg-white/10 transition-all"
          >
            Get In Touch
          </motion.a>
        </motion.div>
        ...
        >
          {[GithubIcon, LinkedinIcon, MailIcon].map((Icon, index) => (
            <motion.a
              ...
              whileTap={{ scale: 0.9 }}
              className="w-12 h-12 rounded-full glass-card flex items-center justify-center text-gray-400 hover:text-white hover:bg-white/10 transition-all"
            >
              <Icon />
            </motion.a>
          ))}
