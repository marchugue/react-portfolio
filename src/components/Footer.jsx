...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    { icon: MailIcon, href: 'mailto:marchugue828@gmail.com', label: 'Email' }
  ];
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div className="flex gap-3">
              {socialLinks.map((social, index) => (
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="w-9 h-9 rounded-lg glass-card flex items-center justify-center text-gray-400 hover:text-white hover:bg-primary-500/20 transition-all"
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li>marchugue828@gmail.com</li>
              <li>Bacolod City, Brgy. Handumanan, Philippines</li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-gray-500 text-sm">
            © {currentYear} Marchugue. All rights reserved.
          </p>
          <p className="text-gray-500 text-sm flex items-center gap-1">
            Made with <span className="text-red-500"><HeartIcon /></span> using React & Tailwind
          </p>
        </div>
      </div>
    </footer>
